...
public class SortingProgram {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Which set would you like to test? Prototype or Large");
        ...
        System.out.println("Which sort? bubble, selection, insertion, shell, quicksort, or for Ciura's Shellsort 'cs'");
